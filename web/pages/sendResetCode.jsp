    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form name="loginForm" action="../sendForgetEmailServlet" method="POST" >
                ...
                <div class="">
                    <button onclick="checkLoginForm()" class="btn btn-success btn-block btn-lg" >Send code</button>
                </div>
                ...
                <a href="login.jsp">I remember my password</a><br>
