            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        <a href="home.html" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="../dist/img/Screen%20Shot%202018-01-20%20at%2018.38.24.png" class="user-image" alt="User Image">
                            <span class="hidden-xs">Kim Quang</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="../dist/img/Screen%20Shot%202018-01-20%20at%2018.38.24.png" class="img-circle" alt="User Image">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview">
                    <a href="#">
                        <i class="fa fa-cutlery"></i> <span>CH?N MEAL T? NGUYÊN LI?U</span>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span>CH?N MEALS CHO NHI?U NGÀY</span>
                        <span class="pull-right-container">
<!--                            <span class="label label-primary pull-right">4h?</span>-->
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-circle-o"></i> MEALS CHO M?T NGÀY</a></li>
