...
public class sendForgetEmailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String messageText = "Your Is Code to Reset Email Password : " + code;
            try {
            ...
            session.setAttribute("code", code);
             session.setAttribute("emailCheck", emailString);
            response.sendRedirect("pages/confirmResetCode.jsp");
