    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("status").equals("scroll")==false) {
            ...
            String resp1 = "<div class=\"row\" style=\"padding-bottom: 30px\">\n"
                    ...
                    + "                                            <h5 style=\"color:#131230;font-family:'Playfair Display',serif;text-transform:capitalize;font-size:20px !important;font-weight:700\">$recipename</h5>\n"
                    ...
                    + "                                            <button class=\"viewdetailbtn\" onclick=\"loadFunction('$ID')\" data-toggle=\"modal\" data-target=\"#fsModal\">More Details</button>\n"
                    + "                                        </div>\n"
                    + "                                    </div>\n"
                    + "                                </div>\n"
                    + "                            </div>";
            String resp2 = " <div class=\"col-md-4 col-sm-6\">\n"
                    ...
                    + "                                </div>\n"
                    + "                            </div>";
            String resp3 = "<div class=\"row\" style=\"padding-bottom: 30px\">\n"
                    + "                            <div class=\"col-md-4 col-sm-6\">\n"
                    + "                                <div class=\"single-food\">\n"
                    + "                                    <div class=\"container1\" style=\"position: relative;\">\n"
                    + "                                        <div class=\"food-img\">\n"
